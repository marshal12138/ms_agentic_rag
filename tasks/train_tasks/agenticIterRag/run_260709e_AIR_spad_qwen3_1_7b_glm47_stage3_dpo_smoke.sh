...
# SPAD-RAG Stage 3 local DPO small-step ablation.
# This validates chosen/rejected data loading and DPO + chosen-SFT loss.
...
bash "${ROOT}/scripts/agenticIterRag_v1/01_pipeline_launcher.sh" \
  ...
  --OVERLAY_YAML=tasks/train_tasks/agenticIterRag/configs/spad_qwen3_1_7b_glm47_stage3_dpo_smoke_overlay.yaml \
  "$@"
