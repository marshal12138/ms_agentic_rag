...
# SPAD-RAG Stage 1 real VERL 5-step effect ablation.
# This is the first small training run used to inspect Search-Policy RL behavior.
...
bash "${ROOT}/scripts/agenticIterRag_v1/01_pipeline_launcher.sh" \
  ...
  --OVERLAY_YAML=tasks/train_tasks/agenticIterRag/configs/spad_qwen3_1_7b_glm47_stage1_5step_overlay.yaml \
  "$@"
