...
# SPAD-RAG Stage 1 real VERL 1-step efficiency smoke.
# This starts Qwen3-1.7B actor training, GLM4.7 teacher, and AIR recall service.
...
bash "${ROOT}/scripts/agenticIterRag_v1/01_pipeline_launcher.sh" \
  ...
  --OVERLAY_YAML=tasks/train_tasks/agenticIterRag/configs/spad_qwen3_1_7b_glm47_stage1_1step_overlay.yaml \
  "$@"
