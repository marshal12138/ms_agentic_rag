...
bash "${ROOT}/scripts/agenticIterRag_v1/01_pipeline_launcher.sh" \
  ...
  --OVERLAY_YAML=tasks/train_tasks/agenticIterRag/configs/spad_qwen3_1_7b_glm47_5100_gold_token_f1_v3_postnorm01_hardgatev2_stage1_overlay.yaml \
  --OVERLAY_YAML=tasks/train_tasks/agenticIterRag/configs/spad_qwen3_1_7b_glm47_64_gold_token_f1_v3_postnorm01_hardgatev2_smoke_overlay.yaml \
  "$@"
