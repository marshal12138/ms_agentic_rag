...
STRATEGY_NAME=coageticretriever_origin_full-inject \
...
cd /data01/ms_wksp/agent_up_to_date/CoSearch_derevitives
STRATEGY_NAME=coageticretriever_origin_no_ranker-inject \
EVAL_BUDGET_YAML="${EVAL_BUDGET_YAML:-scripts/coagenticRetriever_local/strategies_yaml/rollout_cosearch_aligned_budget.yaml}" \
INJECT_TOOL_SCHEMA=true \
AGENT_GPU_IDS=0,1,4,5 \
RANK_GPU_ID=2 \
...
cd /data01/ms_wksp/agent_up_to_date/CoSearch_derevitives/
STRATEGY_NAME=coageticretriever_origin_full-no-inject \
EVAL_BUDGET_YAML="${EVAL_BUDGET_YAML:-scripts/coagenticRetriever_local/strategies_yaml/rollout_cosearch_aligned_budget.yaml}" \
...
cd /data01/ms_wksp/agent_up_to_date/CoSearch_derevitives
STRATEGY_NAME=coageticretriever_origin_no_ranker-no-inject \
EVAL_BUDGET_YAML="${EVAL_BUDGET_YAML:-scripts/coagenticRetriever_local/strategies_yaml/rollout_cosearch_aligned_budget.yaml}" \
INJECT_TOOL_SCHEMA=false \
AGENT_GPU_IDS=0,1,4,5 \
RANK_GPU_ID=2 \
