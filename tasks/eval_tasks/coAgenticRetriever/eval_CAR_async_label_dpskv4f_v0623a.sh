...
RANK_GPU_ID=2 \
RECALL_GPU_ID=3 \
AGENT_MODEL="/data01/ms_wksp/agent_up_to_date/CoSearch_derevitives/checkpoints/qwen3_4b_probe/coAgenticRetriever/260622-220205-CAR_async_ranker_training_ds_flash_mix_signal_b3_v1_select_all/global_step_79" \
RANKER_MODEL="/data01/ms_wksp/agent_up_to_date/CoSearch_derevitives/checkpoints/qwen3_4b_probe/coAgenticRetriever/260622-220205-CAR_async_ranker_training_ds_flash_mix_signal_b3_v1_select_all/global_step_79" \
