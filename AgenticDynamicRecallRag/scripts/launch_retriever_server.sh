...
# Starts the frozen recall retriever service used by CoAgenticRetriever.
#
# Usage:
#   sbatch scripts/launch_retriever_server.sh
#
# The server listens on port 8000 and exposes a /retrieve endpoint.
# Set RETRIEVAL_SERVICE_URL in train_coagentic_retriever_grpo.sh to point to this host:port.
# =============================================================================
...
# =============================================================================
INDEX_FILE="/data01/ms_wksp/agent_up_to_date/CoSearch_derevitives/data/retrieval/wiki-18/e5_Flat.index"
CORPUS_FILE="/data01/ms_wksp/agent_up_to_date/CoSearch_derevitives/data/retrieval/wiki-18/wiki-18.jsonl"
