...
"""
UID grouping functions for ranker/tool training.

These functions assign UIDs to outputs for GRPO training.
UIDs are used to group related retrieval trajectories together.
"""
...
def group_by_muid_ans_in_doc(outputs: List[Any], **kwargs) -> None:
    ...
    Args:
        outputs: List of retrieval trajectory output objects.
