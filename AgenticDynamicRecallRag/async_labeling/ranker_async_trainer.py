...
from ranker_strategies.config import get_nested
...
class RankerAsyncTrainer:
    ...
    def _train_once(self, signals) -> None:
        ...
        batch_size = int(get_nested(self.config, "ranker_training.batch_size", 32))
        fresh_ratio = float(get_nested(self.config, "ranker_training.replay_buffer.fresh_ratio", 0.5))
