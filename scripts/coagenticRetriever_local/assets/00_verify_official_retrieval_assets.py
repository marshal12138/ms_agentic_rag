...
def main() -> None:
    coagentic_learn_root = Path(
        os.getenv("COAGENTIC_LEARN_ROOT", "/data01/ms_wksp/agent_up_to_date/CoSearch_derevitives")
    )
    default_retrieval_dir = coagentic_learn_root / "data/retrieval/wiki-18"
    parser = argparse.ArgumentParser()
    parser.add_argument("--index", type=Path, default=default_retrieval_dir / "e5_Flat.index")
    parser.add_argument("--corpus", type=Path, default=default_retrieval_dir / "wiki-18.jsonl")
