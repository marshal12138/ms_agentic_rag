...
: "${LLM_JUDGE_SERVICE_CONFIG:=${PROJECT_ROOT}/async_ranker_training/configs/llm_judge_vllm_deepseek_flash_gpu06_07.yaml}"
: "${LLM_JUDGE_ENDPOINT:=http://127.0.0.1:8067/v1/chat/completions}"
: "${LLM_JUDGE_MODEL:=DeepSeek-V4-Flash}"
: "${LLM_JUDGE_PROMPT_PATH:=${PROJECT_ROOT}/async_ranker_training/prompts/llm_judge_rank50_v1.md}"
