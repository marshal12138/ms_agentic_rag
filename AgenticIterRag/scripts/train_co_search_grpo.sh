...
# Reward function
# =========================
REWARD_FN_PATH="${PROJECT_ROOT}/rewards/search_qa_f1_with_format_penalty.py"
...
# =========================
UID_GROUP_FN_PATH="${PROJECT_ROOT}/rewards/uid_group_functions.py"
UID_GROUP_FN_NAME="group_by_muid_ans_in_doc_subq_rougeL1"
UID_GROUP_THRESHOLD=0.8

SCORE_ASSIGN_FN_PATH="${PROJECT_ROOT}/rewards/score_assign_functions.py"
