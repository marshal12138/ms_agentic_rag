...
# kernel path: /tmp/torchinductor_root/ik/ciktd2l53xlo3vxnsa5ojvlzz7vl4in6s6jucw5y4pgsojvaqjpd.py
...
#   %full_default : [num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: npu:3, pin_memory: False})
...
@npu_triton_heuristics.reduction_npu_index(
    size_hints=[8411, 151936],
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr1': '*fp32', 'in_ptr0': '*bf16', 'ks0': 'i64', 'x0_numel': 'i32', 'r1_numel': 'i32'}, 'device': NPUDeviceProperties(type='npu', index=3, multi_processor_count=40, cc='Ascend910B3', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, warp_size=None), 'constants': {}, 'mix_mode': 'aiv'},
    inductor_meta={'grid_type': 'GridNpu', 'autotune_hints': set(), 'kernel_name': 'triton_unk_fused__npu_dtype_cast__softmax__to_copy_logsumexp_mul_sub_sum_0', 'mutated_arg_names': ['in_out_ptr1'], 'backend_hash': '011adc744ec7327e0966fe326f3190ef00ba89928c4faa3bc3769d863889216f', 'split_axis': [0], 'tiling_axis': [0, 1], 'axis_names': ['x0', 'r1'], 'low_dims': {1}, 'numof_reduction_axis': 1, 'split_axis_dtype': torch.float32, 'dual_reduction': False, 'traced_graph_hash': 'TRACED_GRAPH_HASH', 'traced_graph_dir': 'TRACED_GRAPH_DIR', 'store_cubin': False, 'force_disable_caches': False, 'profile_bandwidth_with_do_bench_using_profiling': False}
)
@triton.jit
...
def call(args):
    ...
    triton_unk_fused__npu_dtype_cast__softmax__to_copy_logsumexp_mul_sub_sum_0.run(buf5, arg2_1, s57, 8411, 151936, stream=stream3)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 8411
    arg1_1 = 151936
    arg2_1 = rand_strided((8411, 151936), (151936, 1), device='npu:3', dtype=torch.bfloat16)
