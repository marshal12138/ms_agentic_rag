...
# kernel path: /tmp/torchinductor_root/fu/cfu67swmd2ewr6nxffb6ouptftmrizzpy7edibbhmazkyx2yuqxk.py
...
@npu_triton_heuristics.reduction_npu_index(
    size_hints=[8389, 151936],
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr1': '*fp32', 'in_ptr0': '*bf16', 'ks0': 'i64', 'x0_numel': 'i32', 'r1_numel': 'i32'}, 'device': NPUDeviceProperties(type='npu', index=0, multi_processor_count=40, cc='Ascend910B3', major=None, regs_per_multiprocessor=None, max_threads_per_multi_processor=None, warp_size=None), 'constants': {}, 'mix_mode': 'aiv'},
...
def call(args):
    ...
    triton_unk_fused__npu_dtype_cast__softmax__to_copy_logsumexp_mul_sub_sum_0.run(buf5, arg2_1, s57, 8389, 151936, stream=stream0)
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = 8389
    arg1_1 = 151936
    arg2_1 = rand_strided((8389, 151936), (151936, 1), device='npu:0', dtype=torch.bfloat16)
