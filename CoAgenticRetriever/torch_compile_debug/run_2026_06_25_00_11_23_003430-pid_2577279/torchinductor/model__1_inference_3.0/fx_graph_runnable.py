...
class Repro(torch.nn.Module):
    ...
    def forward(self, arg0_1, arg1_1, arg2_1):
        ...
        full_default = torch.ops.aten.full.default([], 0.0, dtype = torch.float32, layout = torch.strided, device = device(type='npu', index=2), pin_memory = False)
...
def load_args(reader):
    reader.symint(8415)  # arg0_1
    reader.symint(151936)  # arg1_1
    buf0 = reader.storage(None, 2*s57*(s1 - 1) + 2*s57, device=device(type='npu', index=2), dtype_hint=torch.bfloat16)
