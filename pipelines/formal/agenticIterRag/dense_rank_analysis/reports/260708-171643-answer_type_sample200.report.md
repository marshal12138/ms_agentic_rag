...
## 基本信息
- created_at: `2026-07-08 17:16:43`
...
- report_path: `/data01/ms_wksp/agent_up_to_date/CoSearch_derevitives/pipelines/formal/agenticIterRag/dense_rank_analysis/reports/260708-171643-answer_type_sample200.report.md`
...
| type | count | pct |
| --- | ---: | ---: |
| `proper_name_entity` | 63 | 31.5% |
| `date_or_time_expression` | 33 | 16.5% |
| `short_entity_or_short_phrase` | 25 | 12.5% |
| `year` | 16 | 8.0% |
| `common_noun_phrase` | 13 | 6.5% |
| `yes_no` | 12 | 6.0% |
| `multi_answer_list` | 8 | 4.0% |
| `multi_answer_set_with_aliases` | 7 | 3.5% |
| `geo_or_nationality` | 7 | 3.5% |
| `number_or_ordinal` | 6 | 3.0% |
| `organization_work_or_event` | 3 | 1.5% |
| `entity_or_phrase_other` | 3 | 1.5% |
...
| type | count | pct |
| --- | ---: | ---: |
| `proper_name_entity` | 89 | 38.4% |
| `short_entity_or_short_phrase` | 34 | 14.7% |
| `date_or_time_expression` | 33 | 14.2% |
| `common_noun_phrase` | 18 | 7.8% |
| `year` | 16 | 6.9% |
| `yes_no` | 12 | 5.2% |
| `geo_or_nationality` | 9 | 3.9% |
| `number_or_ordinal` | 6 | 2.6% |
| `organization_work_or_event` | 4 | 1.7% |
| `long_descriptive_phrase` | 4 | 1.7% |
| `acronym_or_code` | 4 | 1.7% |
| `entity_or_phrase_other` | 3 | 1.3% |
...
| `short_entity` | 47 | 20.3% |
| `time_like` | 33 | 14.2% |
| `common_phrase` | 18 | 7.8% |
| `year_like` | 16 | 6.9% |
| `leading_fragment` | 15 | 6.5% |
| `boolean_answer` | 12 | 5.2% |
| `longer_phrase` | 10 | 4.3% |
| `numeric_or_ordinal` | 6 | 2.6% |
...
- `Saba` | sample_id=`sample-001178:step:1` | question: where is saba university school of medicine located? | sub_query: Saba University School of Medicine location

### `proper_name_entity`

这类是首字母大写的专名实体，包括人名、地名、机构名、作品名或页面标题。它通常比数字/年份稳定，但仍然不能直接等同 true evidence，因为列表页、演员表、消歧义页也会提到这些名字。
...
- `Danny Denzongpa` | sample_id=`sample-000775:step:1` | question: who was considered for the role of gabbar first? | sub_query: who was considered for the role of gabbar first in sholay
- `Robert Howie` | sample_id=`sample-000891:step:2` | question: Who died later, Robert Howie or Beatrice Hatch? | sub_query: Robert McConnell Hatch death date
...
- `Wembley Stadium` | sample_id=`sample-002230:step:3` | question: Where did the torch relay begin in the place of birth of On Her Majesty's Secret Service's author for the 2008 Olympics? | sub_query: where did the torch relay begin for 2008 olympics
...
- `the South` | sample_id=`sample-002232:step:1` | question: where was the second half of the american revolutionary war primarily fought? | sub_query: where was the second half of the american revolutionary war primarily fought
...
- `opera` | sample_id=`sample-000139:step:3` | question: What was the genre of the Sextet composer? | sub_query: minimal music genre
- `Opera` | sample_id=`sample-000139:step:3` | question: What was the genre of the Sextet composer? | sub_query: minimal music genre
- `opera | Opera` | sample_id=`sample-000139:step:3` | question: What was the genre of the Sextet composer? | sub_query: minimal music genre
- `Bob Marley` | sample_id=`sample-000163:step:1` | question: who made the song i shot the sheriff? | sub_query: I Shot the Sheriff song writer
...
- `the South` | sample_id=`sample-002232:step:1` | question: where was the second half of the american revolutionary war primarily fought? | sub_query: where was the second half of the american revolutionary war primarily fought
- `the third Sunday of June` | sample_id=`sample-002241:step:1` | question: when do we celebrate father's day in india? | sub_query: Father's Day in India date
